...
历史收敛检查点：女娲独立工作区范围已随 PR #12 合入 main；此前“本轮止于收敛”的文字不再是当前停止条件。MAP-M3 与“资料整理与世界设定 M1”已作为资料里程碑基线合入。当前短分支正在收敛“核心导航与作者便捷性整合”：资料库、地图、关系统一归属顶级“资料”，补齐固定二级导航、未保存保护、局部图/关系/天意依据往返、三尺寸画面与普通入口验收；隔离浏览器使用本地假 Provider，真实 Provider 0 次。日常 4191/4192 实际切换仍服从既有升级手册的集中确认门。
