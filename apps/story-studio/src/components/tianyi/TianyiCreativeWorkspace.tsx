...
import type { TianyiAgentRunProjection, TianyiContextRequest, TianyiCreativeProjection } from "../../lib/localTransport";
...
export function TianyiCreativeWorkspace(props: { projectId: string; token: string; sessionId: string | null; operations: TianyiV2Operations; onSessionId(sessionId: string): void; sharedDraft: string; onDraft(value: string): void; withConnection?: <T>(action: (token: string) => Promise<T>) => Promise<T> }) {
