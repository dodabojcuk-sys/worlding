...
export type TianyiCreativeEventReview = { version: "tianyan-tianyi-event-review-bridge/r0"; proposal: { id: string; title: string; summary: string; origin: { projectId: string; sessionId: string; eventId: string; version: string }; writeTarget: { storyId: string; version: string; owner: string }; evidence: Array<{ sourceRef: string; excerpt: string }>; unknowns: string[] }; planning: { id: string; title: string; revision: string } | null; candidateReview: GoldenLoopCandidateReview | null; impact: { id: string; status: string; options: Array<{ id: string; label: string; summary: string }> } | null; changeSet: { id: string; status: string; application: { appliedEventId: string | null } } | null; confirmedEvents: Array<{ id: string; title: string; revision: string }>; writeBoundary: { canon: 0; worldState: 0; event: 0; provider: 0; plugin: 0 } };
