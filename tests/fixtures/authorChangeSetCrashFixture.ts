...
function workflowSemanticFingerprints(projectPath: string, changeSetId: string) {
  ...
  const semantic = {
    ...
    ...(persisted.workVersionId === undefined ? {} : { workVersionId: persisted.workVersionId }),
    source: persisted.source,
    ...(persisted.sourceKnowledgeSubjects ? { sourceKnowledgeSubjects: persisted.sourceKnowledgeSubjects } : {}),
