...
test("relation handoff preserves distinct endpoint materials and exact event revisions", () => {
  const params = new URLSearchParams("tianyiSource=relations&relationRef=relation.7&relationLabel=%E9%A9%BB%E6%B8%AF%E8%B0%83%E6%9F%A5&materialRef=place.fog&materialRef=char.lin&materialRef=char.lin&eventRef=event.port&eventRevision=event-r3");
