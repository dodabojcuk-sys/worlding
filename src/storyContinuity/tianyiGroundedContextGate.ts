...
export type TianyiGroundedSourceType = "writing" | "scene" | "world-object" | "rule" | "memory" | "map" | "material-file";
...
function normalizeCandidate(value: TianyiGroundedResolvedCandidate): TianyiGroundedResolvedCandidate {
  const sourceType = oneOf(value.sourceType, ["writing", "scene", "world-object", "rule", "memory", "map", "material-file"] as const, "Tianyi grounded source type");
...
function manifestEntries(
  ...
  return value.map((item) => {
    ...
    return {
      sourceType: oneOf(input.sourceType, ["writing", "scene", "world-object", "rule", "memory", "map", "material-file"] as const, "Tianyi grounded source type"),
